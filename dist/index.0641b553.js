...
fetch("https://randomuser.me/api/?results=20").then((res)=>res.json()).then((data)=>{
    ...
    allData.forEach(function(contact) {
        ...
        const user = new (0, _userDefault.default)(contact.name.title, contact.name.first, contact.name.last, contact.dob.age, contact.email, contact.picture.large);
...
container.addEventListener("click", (e)=>{
    ...
    // console.log(user);
    // si user est present
    if (user.dataset.present === "true") // on le cache
...
},{"./User":"3Nf0z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3Nf0z":[function(require,module,exports) {
// User.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
